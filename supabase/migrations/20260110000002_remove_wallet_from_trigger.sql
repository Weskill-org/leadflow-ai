-- Remove wallet creation logic from handle_new_user
...
BEGIN
  ...
  -- Wallet creation REMOVED as per user request
  
  -- 5. Create User Stats (Keeping this as it might be used for other stats, or can be removed if requested)
  BEGIN
